...
(function () {
  ...
  var IMG = {
    chuck:   "assets/img/beef-chuck.png",
    ribeye:  "assets/img/beef-ribeye.png",
    strip:   "assets/img/beef-strip.png",
    shabu:   "assets/img/set-shabu.png",
    yaki:    "assets/img/set-yakiniku.png",
    fig:     "assets/img/sauce-fig.png",
    bulgogi: "assets/img/sauce-bulgogi.png",
    spicy:   "assets/img/sauce-spicy.png",
    gravy:   "assets/img/sauce-gravy.png",
    dashi:   "assets/img/soup-dashi.png"
  };
